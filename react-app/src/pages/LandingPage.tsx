...
const places:WorldPlace[]=[
  {name:'세종호수공원',description:'축제와 지역 볼거리에서 취향 발견',people:'시작',emoji:'🎪',image:lakeMapPreview,modelUrl:lakeWorldUrl,modelSize:'3.9MB',accent:'#2f72c7',mapId:'town',points:['축제·공연 체험존','지역 먹거리·상점','방문 코스 게시판']},
...
const guideWorldCatalog:WorldPlace[]=[
  ...
  {name:'세종호수공원',description:'세종의 축제와 먹거리, 공연을 체험하며 나의 여행 취향을 발견하는 시작 월드예요.',people:'취향 발견',emoji:'🎪',image:lakeMapPreview,modelUrl:lakeWorldUrl,modelSize:'3.9MB',accent:'#2f72c7',mapId:'town',points:['축제 부스에서 선호 분위기 선택','공연·먹거리 부스에서 여행 스타일 분석','5개 포탈로 세종의 다음 공간 탐험']},
