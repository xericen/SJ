...
| 공간 | 웹에서 실제로 하는 일 | Experience Harness·AI 반영 |
|---|---|---|
| 세종호수공원 | 3D 공원 걷기, 세종 추천 코스 확인, 공연·축제·먹거리 공간 둘러보기 | 이동·체류와 문화·미식·체험 콘텐츠 열람 |
| 국립세종수목원 | 식물에 다가가 관찰·채집, 식물 도감과 5종 기억나무 진행 확인 | 식물 발견·반복 관찰을 자연 취향과 정원 진행도에 반영 |
| 베어트리파크 | 생태 공간 탐험, 포토존 체험, 곰 체험소에서 먹이 수집·5회 급여 | 탐험 경로·체류·생태 체험과 미션 완료 행동 |
| 공동캠퍼스 | 학생회관·모집센터·프로젝트실·동아리 거리제 방문, 동아리·모집글·프로젝트 활동 | 관심사·교류·협업 활동과 커뮤니티 참여 성향 |
| 정부청사 | 중앙광장 AI 추천센터, 전망대, 스마트시티 전시를 체험하고 누적 결과 확인 | 앞선 공간의 행동을 통합해 AI 세종 프로필과 맞춤 코스 생성 |
...
세종한바퀴는 세종시의 생활권, 공공 공간, 문화·관광 자원과 지역 커뮤니티를 하나의 3D 월드로 연결한 체험형 AI 메타버스 플랫폼입니다. 사용자는 자신의 캐릭터로 17개 공간을 탐험하고, 지역 이웃·동아리·모집글·프로젝트를 발견하며, Experience Harness가 기록한 행동을 AI가 해석해 개인화된 세종 프로필과 맞춤 코스로 연결합니다.
