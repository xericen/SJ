...
세종시의 생활권, 공공 공간, 문화·관광 자원과 지역 커뮤니티를 하나의 3D 월드에서 연결하는 웹 서비스입니다. 사용자는 카카오 로그인 또는 DB 저장 없는 로컬 체험으로 캐릭터를 만들고, 세종의 여러 공간을 이동하며 이웃·동아리·프로젝트를 만나고 AI 기반 지역 추천과 체험 콘텐츠를 이용할 수 있습니다.
...
- 세종호수공원, 정부청사, 세종예술의전당, 축제부스 포털은 서버에서 고정되어 편집 요청이 차단됩니다.
