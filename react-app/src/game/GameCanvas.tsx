...
export const GameCanvas=memo(function GameCanvas({profile,returnState,previewOnly=false,previewDragRotate=false,authenticated=Boolean(localStorage.getItem('jochiwon-kakao-user-id')?.trim()),onNotice}:{profile:UserProfile;returnState?:GameReturnState;previewOnly?:boolean;previewDragRotate?:boolean;authenticated?:boolean;onNotice?:(message:string)=>void}){
