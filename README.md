...
3. 공통 걷기·달리기 조작과 공간별 지형에 맞춘 카메라로 17개 월드를 탐색합니다.
4. 국립세종수목원에서 14종 식물을 발견해 도감을 채우고 5·10·14종마다 성장하는 기억나무와 충녕 AI 분석을 확인합니다.
5. 마이홈에서 탐험 기록이 정원 풍성도와 대표 식물로 연결되는 흐름, 실내 출입·좌석·침대 상호작용을 확인합니다.
...
- 수목원 발견 식물 수·반복 관찰에 따라 성장하는 정원과 곰 FBX 모델, 진행도 기반 보상 오브젝트 표시
...
- 세종호수공원, 공동캠퍼스, 베어트리파크, 세종예술의전당과 축제·먹거리 부스의 확정 포털은 서버에서 고정되어 편집 요청이 차단됩니다.
- 정부청사의 중앙광장·전망대·스마트시티 포털과 일부 귀환 포털은 권한 사용자가 현재 위치로 옮길 수 있으며, 공용 저장 또는 브라우저 로컬 저장 정책을 공간별로 구분합니다.
