...
export interface UserProfile{nickname:string;residence?:string;sejongVisitExperience?:string;mbti:string;interests:string[];usagePurposes:string[];preferredPlaceCategories:string[];recordVisibility?:'public'|'private';chatEnabled?:boolean;character:CharacterParts;model:CharacterModel}
